...
async function editLesson(lesson_id: number) {
  console.log("lesson_id" , lesson_id)
 // const res: Res = await axios.put(`${BASE_URL}/${lesson.event_id}`, lesson);
 const res: Res = await axios.put(`${BASE_URL}/${lesson_id}`);
